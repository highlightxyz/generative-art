...
- Your .zip should not be larger than 2GB. All project assets are stored on Arweave by default, a decentralized and permanent storage network. To add your script or other elements of your project onchain, see here.
...
**[Download an example project &darr;](https://github.com/highlightxyz/generative-art/raw/main/examples/basic-p5-example/BASIC-P5-EXAMPLE-UPLOAD-ME.zip)**
